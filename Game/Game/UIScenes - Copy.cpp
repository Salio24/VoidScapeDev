...
void UIScenes::LoadTitleScreen(const int& tilesetOffset) {
...

	{
		...
		i.Possition = glm::vec2(960.0f, 580.0f);
		i.Color = glm::vec3(0.80859375f, 0.80078125f, 0.81640625f);
		i.Text = "Retry";
		i.Scale = 0.25f;

		f.Possition = glm::vec2(960.0f, 580.0f);
		f.Color = glm::vec3(0.80859375f, 0.80078125f, 0.81640625f);
		f.Text = "Restart";
		f.Scale = 0.25f;

		mInGameTitleButtonMap.emplace("RETRY", b);
		mInGameTitleDynamicTextMap.emplace("RETRY", t);

		mInGameDeathTextToRender.push_back(i);
		mInGameDeathTextToRender.back().ModelMatrix = &mInGameTitleButtonMap["RETRY"].mModelMatrix;

		mInGameEscapeTextToRender.push_back(f);
		mInGameEscapeTextToRender.back().ModelMatrix = &mInGameTitleButtonMap["RETRY"].mModelMatrix;
	} {
		Button b;
		Text t;
		Text f;
		...
		f.Possition = glm::vec2(960.0f, 480.0f);
		f.Color = glm::vec3(0.80859375f, 0.80078125f, 0.81640625f);
		f.Text = "Auto Retry";
		f.Scale = 0.25f;
		...
		mInGameDeathTextToRender.push_back(t);
		mInGameDeathTextToRender.back().ModelMatrix = &mInGameTitleButtonMap["AUTO_RETRY"].mModelMatrix;

		mInGameEscapeTextToRender.push_back(f);
		mInGameEscapeTextToRender.back().ModelMatrix = &mInGameTitleButtonMap["AUTO_RETRY"].mModelMatrix;
	} {
		Button b;
		Text t;
		Text f;
		...
		f.Possition = glm::vec2(960.0f, 200.0f);
		f.Color = glm::vec3(0.80859375f, 0.80078125f, 0.81640625f);
		f.Text = "Back to main menu";
		f.Scale = 0.25f;

		mInGameTitleButtonMap.emplace("BACK_TO_MENU", b);

		mInGameDeathTextToRender.push_back(t);
		mInGameDeathTextToRender.back().ModelMatrix = &mInGameTitleButtonMap["BACK_TO_MENU"].mModelMatrix;

		mInGameEscapeTextToRender.push_back(f);
		mInGameEscapeTextToRender.back().ModelMatrix = &mInGameTitleButtonMap["BACK_TO_MENU"].mModelMatrix;
	}
	...
	y.Text = "Game Over";
	y.Scale = 1.0f;
	mInGameDeathTextToRender.push_back(y);
	mInGameDeathTextToRender.back().ModelMatrix = &globalUIModelMatrix;

	u.Possition = glm::vec2(960.0f, 900.0f);
	u.Color = glm::vec3(0.8125f, 0.0f, 0.875f);
	u.Text = "Escaped";
	u.Scale = 1.0f;
	mInGameEscapeTextToRender.push_back(u);
	mInGameEscapeTextToRender.back().ModelMatrix = &globalUIModelMatrix;
}
